...
const imageUrl = [
    "https://dn-img-page.kakao.com/download/resource?kid=cSZvNP/hyATtZmAek/QlK4PcBrTSxbHzZKk6GFxk",
    "https://dn-img-page.kakao.com/download/resource?kid=i3VME/hyzTW11Sej/nqAnIwR444EEC1NXwAQrf1",
    "https://s.w-x.co/84impacts1.jpg"
];

for (i=0; i<3; i++) {
    modules.fetchImage(imageUrl[i]).then(function(response) { console.log(response) });
}